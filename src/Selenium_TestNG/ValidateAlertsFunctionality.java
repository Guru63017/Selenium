...
public class ValidateAlertsFunctionality 
{
	@Test
	public void ValidateAlerts() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		WebElement clickme = driver.findElement(By.xpath("//*[@id='alertBox']"));
		...
		Assert.assertEquals(alertTextActual, expectedData,"miss match");
		...
		String expectedAlertData = "You selected alert box";
