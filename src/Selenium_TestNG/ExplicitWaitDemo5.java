...
public class ExplicitWaitDemo5 
{
	...
	public void ExplicitWait() throws InterruptedException
	{
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='ContentHolder_lbModels_RBG_D']")));  
		/**
		 * when we give the Wrong xpath it waits until the time is reached
		 * after that it gives Timeout Exception
		 * 
